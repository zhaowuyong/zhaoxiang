...
%>
                <td width="50%"> <br>
                  商品名称:<%=rs.getString("ItemTitle")%> <br> <a href="views.jsp?ItemID=<%=hwid%>">
                  <img border="0" src="<%=rs.getString("hw_pic")%>" width="114" height="83" vspace="6"></a>
                  <br>
                  最高价：<%=rs.getInt("BidPrice")%>元 <br> <a target="_blank" href="views.jsp?ItemID=<%=hwid%>">详情</a>
                  <%

                  if((String)session.getValue("user_name")!=null)
                  {
                  %>
                 <a href="javascript:openScript('BidForm.jsp',460,300)">竞拍<img border="0" src="img/order.gif" width="21" height="15"></a>
                  <%
                   }else
                   {
                   }
