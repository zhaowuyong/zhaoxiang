...
%>
         ...
         <td width="83" align="center" height="28" background="img/main.gif"><a href="sort.jsp?sort_id=<%=rs.getInt("sort_id")%>"><%=rs.getString("sort_name")%></a></td>
          <%
			 if(a>=7)
			 break;
		 }
  ...
  <td width="98" align="center" height="28" background="img/main.gif">
     <a target="_blank" href="#">客户论坛</a></td></tr></table>
</td></tr></table>
...
| <a href="fukuan-fangshi.jsp">交易方式</a>
...
<%
  ...
  if((String)session.getValue("user_name")!=null) 
    {
%>
| <a href="javascript:openScript('BidForm.jsp',600,400)">竞拍</a>
| <a href="javascript:openScript('dls.jsp',600,400)">提交商品</a>
...
显示时间
-->
<script src="http://www.jspshop.cn/jspt/mystat.asp"></script>
<script language="JavaScript">
<!--
todayDate = new Date();
