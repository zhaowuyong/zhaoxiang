...
boolean founderr=false;
    ...
    if(sort_ids=="" )
	{
	  ...
	  if(data.length()!=10){
	    errmsg=errmsg+"<br>"+"<li>产品拍卖截止日期格式不正确";
        founderr=true;
	  }else
	  {
  ...
  <tr>
    <td width="100%" height="395"> 
            ...
            <table border="0" width="100%" cellspacing="1">
              ...
              <tr> 
                <td colspan="2"><font color="#FF0000">&nbsp;&nbsp;&nbsp;底价</font> 
                  <input type="text" name="StartingPrice" size="7" class=input>
                  元 <font color="#FF0000">&nbsp;&nbsp;&nbsp;&nbsp;竞拍价</font> 
              ...
              <tr> 
                ...
                <td width="63%"><font color="#000000">截止日期</font> 
              ...
              <tr> 
                <td valign="top" colspan="2"> 
                  <textarea rows="3" name="Description" cols="50" class=input>暂时没有……</textarea>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td valign="top" colspan="2">
                  <textarea rows="10" name="Content" cols="50" class=input>暂时没有……</textarea>
                </td>
              </tr>
              
                <tr><td colspan="2"> <font color="#FF0000">图片地址</font> 
