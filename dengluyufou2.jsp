                  ...
                  <td width="100%" height="18"> <table width="100%" border="0" cellspacing="1" cellpadding="0">
                      <tr>
                        <td> <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFE1FF" style="border-collapse: collapse" bordercolor="#111111">
                            ...
                            <tr>
                              <td width="86%" height="20" bgcolor="#FEA5FE"> <div align="center"><b>用户信息:</b></div></td>
                            </tr>
                            <tr>
                      ...
                      <form method="POST" action="login2.jsp">
                        <tr>
                          <td height="110" bgcolor="#FFE1FF"> <table width="95%" border="0" align="center" cellpadding="0" cellspacing="5">
                              <tr>
                                <td width="32%" bgcolor="#FFE1FF"> <div align="center">客户：</div></td>
                              ...
                              <tr>
                                <td bgcolor="#FFE1FF"> <div align="left">身份证号：</div></td>
                                <td bgcolor="#FFE1FF"> <div align="center">
                                    <input style="FONT-SIZE: 12px; WIDTH: 110px" type="text" name="user_shenfenzheng" size="10" class=input maxlength="18">
                                  </div></td>
                              </tr>
                            </table>
