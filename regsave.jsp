...
String errmsg="<font size=4 color=red>错误!</font>";
...
if(rs.next()){
    errmsg=errmsg+"<font size=4 color=red>用户名已被别人注册</font>";
    founderr=true;
}
...
<table border="0" width="500" cellspacing="0" cellpadding="0" height="5" style="border-collapse: collapse" bordercolor="#111111">
          ...
          <%if(founderr==false){
			  String sql1;
              sql1="Insert into member(user_name,user_pass,user_shenfenzheng,user_adds,user_mail,user_tel,user_postcode,user_regip,user_namec,user_type) values('"+user_name+"','"+user_pass+"','"+user_shenfenzheng+"','"+user_adds+"','"+user_mail+"','"+user_tel+"','"+user_postcode+"','"+request.getRemoteHost()+"','"+getStr(request.getParameter("user_namec"))+"','会员')";
              mdb.executeInsert(sql1);
            %>
          <tr>
            <td height="25" align="center" bgcolor="#FEA5FE">注册成功</td>
                  ...
                  <div align="center">
                    ...
                    <table width="90%" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111">
                     <meta http-equiv="refresh" content="5;url=index.jsp">
                      ...
                      <tr>
                        <td width="33%" height="25"><div align="right">身份证号：</div></td>
                      ...
                      <td height="25" colspan="2"> <div align="center"><a href="index.jsp" target="_blank">请返回首页登陆,五秒后自动返回</a></div></td>
                      <tr>
                        <td colspan="2"></td>
                      </tr>
                      <tr>
		  ...
		  {%>
          <tr>
            <td width="100%" height="25" align="center" bgcolor="#FEA5FE">注册失败</td>
          </tr>
          <tr>
          ...
          <tr><td height="25" colspan="2"> <div align="center"><a href="reg.jsp">请返回重填</a></div></td></tr>
        </table>
